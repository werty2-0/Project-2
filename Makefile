runApp: Backend.java Frontend.java App.java DijkstraGraph.java GraphADT.java BackendInterface.java FrontendInterface.java
	javac --module-path ../javafx/lib --class-path=.:../junit5fx.jar --add-modules javafx.controls Frontend.java
	javac --module-path ../javafx/lib --class-path=.:../junit5fx.jar --add-modules javafx.controls Backend.java
	javac --module-path ../javafx/lib --class-path=.:../junit5fx.jar --add-modules javafx.controls App.java
...
runBDTests: Backend.java BackendInterface.java GraphADT.java
	javac --module-path ../javafx/lib --add-modules javafx.controls -cp .:../junit5fx.jar Backend.java
